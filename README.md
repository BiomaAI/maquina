...
Operation Nightglass also exports an optional counterfactual command graph.
...
outcomes. The static browser never runs mission rules: all 11 snapshots, 10
resolution edges, receipts, and four outcome classes are generated by Lean.
